...
static cocos2d::Size designResolutionSize = cocos2d::Size(855, 480);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("hellogame", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
