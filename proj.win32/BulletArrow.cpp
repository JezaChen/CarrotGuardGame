...
bool BulletArrow::init(const int& rId, VictimEntityBase* rVictimEntity, const int& rotation)
{
    bool bRet = false;
    do
    {
...
BulletArrow* BulletArrow::create(const int& rId, VictimEntityBase* rVictimEntity, const int& rotation)
{
    //分配内存给子弹指针；
    BulletArrow* pBullet = new BulletArrow();
    //初始化成功；
